 ...
 * Uses new lifestyle constants from src/features/lifestyles/constants.ts
 */
...
import type { LifestyleCategory } from '../constants';
    ...
    >
        ...
        style={[
          ...
          !selectedCategory && styles.chipActive,
          {
            backgroundColor: !selectedCategory
              ? colors.primary
              : colors.surfaceSecondary || colors.inputBackground || '#F5F5F5',
            borderColor: !selectedCategory ? colors.primary : colors.border || '#E0E0E0',
          },
        ]}
      ...
      >
        <Text
          style={[
            styles.chipText,
            { color: !selectedCategory ? '#FFF' : colors.textSecondary || '#666' },
          ]}
        >
          {t('lifestyles.categories.all') || 'All'}
        </Text>
      </TouchableOpacity>
