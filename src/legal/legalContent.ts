...
To exercise these rights, contact us at [SUPPORT EMAIL]. We may ask you to verify your identity.
...
[НАЗВАНИЕ КОМПАНИИ]  
Email для связи: [EMAIL ДЛЯ СВЯЗИ]
...
По вопросам реализации прав напишите на [EMAIL ДЛЯ СВЯЗИ]. Мы можем запросить подтверждение личности.
...
Құқықтарыңызды жүзеге асыру үшін [ҚОЛДАУ EMAIL] мекенжайына жазыңыз. Біз жеке басыңызды растауды сұрай алуымыз мүмкін.
...
You may stop using the App at any time. Where available, you can delete your account in the profile settings or by contacting us at [SUPPORT EMAIL].
...
All rights to the App (design, texts, logos, code, databases and other elements), except user content, belong to [COMPANY NAME] and/or its partners.
...
Вы можете в любой момент прекратить использование Приложения. При наличии соответствующей функции вы можете удалить аккаунт в настройках профиля или запросить удаление по email [EMAIL ДЛЯ СВЯЗИ].
...
Все права на Приложение (дизайн, логотипы, тексты, программный код, базы данных и др.), за исключением пользовательского контента, принадлежат [НАЗВАНИЕ КОМПАНИИ] и/или нашим партнёрам.
...
Сіз Қосымшаны кез келген уақытта пайдалануды тоқтата аласыз. Мүмкін болған жағдайда аккаунтты профиль баптауларында өшіруге немесе [ҚОЛДАУ EMAIL] мекенжайына жаза отырып жоюды сұрауға болады.
...
Пайдаланушы контентінен басқа, Қосымшаға (дизайн, логотиптер, мәтіндер, код, дерекқорлар және т.б.) барлық құқықтар [КОМПАНИЯ АТАУЫ] және/немесе біздің серіктестерімізге тиесілі.
