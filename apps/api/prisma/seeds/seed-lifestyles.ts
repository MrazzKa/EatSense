...
interface LifestyleProgram {
    slug: string;
    name: { en: string; ru: string; kk: string; fr?: string };
    subtitle: { en: string; ru: string; kk: string; fr?: string };
    description: { en: string; ru: string; kk: string; fr?: string };
    shortDescription: { en: string; ru: string; kk: string; fr?: string };
    category: string;
    type: DietType;
    ...
    embrace: string[];
    minimize: string[];
    dailyTracker: { key: string; label: { en: string; ru: string; kk: string; fr?: string } }[];
    suitableFor: string[];
    isFeatured: boolean;
...
const lifestylePrograms: LifestyleProgram[] = [
    ...
    {
        slug: 'that_girl',
        name: { en: 'That Girl', ru: 'That Girl', kk: 'That Girl', fr: 'That Girl' },
        subtitle: { en: '5AM, green juice, main character energy', ru: '5 утра, зелёный сок, энергия главного персонажа', kk: 'Таңғы 5, жасыл шырын, басты кейіпкер энергиясы', fr: '5h, jus vert, énergie personnage principal' },
        description: { en: 'Wellness as aesthetic. Green smoothies, matcha, overnight oats. Looking good, feeling good.', ru: 'Здоровье как эстетика. Зелёные смузи, матча, овсянка на ночь.', kk: 'Денсаулық эстетика ретінде. Жасыл смузи, матча.', fr: 'Le bien-être comme esthétique. Smoothies verts, matcha, overnight oats.' },
        shortDescription: { en: '5AM routine, green juice, main character energy', ru: '5 утра, зелёный сок, энергия главного персонажа', kk: 'Таңғы 5, жасыл шырын', fr: 'Routine 5h, jus vert, énergie protagoniste' },
        category: 'trending',
        ...
        dailyTracker: [
            { key: 'morning_routine', label: { en: 'Morning routine 5AM', ru: 'Утренняя рутина 5 утра', kk: 'Таңғы 5-те режим', fr: 'Routine matin 5h' } },
            { key: 'green_juice', label: { en: 'Green smoothie or matcha', ru: 'Зелёный смузи или матча', kk: 'Жасыл смузи немесе матча', fr: 'Smoothie vert ou matcha' } },
            { key: 'aesthetic_meal', label: { en: 'Aesthetic healthy meal', ru: 'Эстетичная здоровая еда', kk: 'Эстетикалық сау тағам', fr: 'Repas sain esthétique' } },
            { key: 'hydration', label: { en: 'Stay hydrated', ru: 'Пейте воду', kk: 'Су ішу', fr: 'Rester hydraté' } },
        ],
    ...
    {
        slug: 'clean_girl',
        name: { en: 'Clean Girl', ru: 'Clean Girl', kk: 'Таза Қыз', fr: 'Clean Girl' },
        subtitle: { en: 'Minimal, glowing, effortless beauty', ru: 'Минимализм, сияние, естественная красота', kk: 'Минималистік, жарқыраған, табиғи сұлулық', fr: 'Minimal, lumineux, beauté naturelle' },
        description: { en: 'The no-makeup makeup of eating. Whole foods, nothing processed, maximum hydration.', ru: 'Еда без макияжа. Цельные продукты, ничего обработанного.', kk: 'Макияжсыз тағам. Толық тағамдар.', fr: 'Alimentation sobre et saine. Aliments complets, hydratation max.' },
        shortDescription: { en: 'Minimal, glowing, effortless', ru: 'Минимализм, сияние, естественность', kk: 'Минималистік, жарқыраған', fr: 'Minimal, lumineux, effortless' },
        category: 'trending',
        type: DietType.LIFESTYLE,
        difficulty: DietDifficulty.EASY,
        duration: 14,
        ...
        dailyTracker: [
            { key: 'whole_foods', label: { en: 'Whole foods only', ru: 'Только цельные продукты', kk: 'Тек толық тағамдар', fr: 'Aliments complets uniquement' } },
            { key: 'hydration', label: { en: '3L water', ru: '3л воды', kk: '3л су', fr: '3 L eau' } },
            { key: 'simple_meal', label: { en: 'Simple clean meal', ru: 'Простая чистая еда', kk: 'Қарапайым таза тағам', fr: 'Repas simple et sain' } },
        ],
    ...
    {
        slug: 'old_money',
        name: { en: 'Old Money', ru: 'Старые Деньги', kk: 'Ескі Ақша', fr: 'Old Money' },
        subtitle: { en: 'Quiet luxury, timeless elegance', ru: 'Тихая роскошь, вечная элегантность', kk: 'Тыныш сәнділік, мәңгі элеганттылық', fr: 'Luxe discret, élégance intemporelle' },
        description: { en: 'Quality over everything. Grass-fed, wild-caught, organic, artisanal. No chain restaurants.', ru: 'Качество превыше всего. Травяное, дикое, органическое.', kk: 'Сапа бәрінен жоғары.', fr: 'La qualité avant tout. Bio, artisanal, pas de chaînes.' },
        shortDescription: { en: 'Quality over quantity, timeless elegance', ru: 'Качество важнее количества', kk: 'Сапа санынан маңызды', fr: 'Qualité avant quantité' },
        category: 'trending',
        type: DietType.LIFESTYLE,
        difficulty: DietDifficulty.EASY,
        duration: 14,
        ...
        dailyTracker: [
            { key: 'quality_ingredients', label: { en: 'Quality ingredients', ru: 'Качественные ингредиенты', kk: 'Сапалы ингредиенттер', fr: 'Ingrédients de qualité' } },
            { key: 'proper_dining', label: { en: 'Proper table setting', ru: 'Правильная сервировка', kk: 'Дұрыс сервировка', fr: 'Bonne mise en table' } },
    ...
    },
    {
        ...
        description: { en: 'La dolce vita on your plate. Fresh tomatoes, burrata, olive oil, pasta, wine.', ru: 'Сладкая жизнь на тарелке. Помидоры, буррата, оливковое масло.', kk: 'Табақтағы тәтті өмір.', fr: 'La dolce vita dans l\'assiette. Tomates, burrata, huile d\'olive, pâtes, vin.' },
    ...
    },
    {
        ...
        subtitle: { en: 'Train hard, eat smart, perform better', ru: 'Тренируйся усердно, ешь умно', kk: 'Қатты жаттығу, ақылды жеу', fr: 'S\'entraîner fort, manger malin, mieux performer' },
    ...
    },
    {
        ...
        subtitle: { en: 'Calm inflammation, clear breakouts', ru: 'Успокоить воспаление, очистить высыпания', kk: 'Қабынуды тыныштандыру', fr: 'Apaiser l\'inflammation, peau nette' },
    ...
    },
    {
        ...
        description: { en: 'Japanese-inspired minimalism. Few ingredients, high quality.', ru: 'Японский минимализм.', kk: 'Жапонға шабыттанған минимализм.', fr: 'Minimalisme inspiré du Japon. Peu d\'ingrédients, qualité.' },
    ...
    },
    {
        ...
        description: { en: 'Fight camp nutrition. High protein, strategic carbs.', ru: 'Питание бойцовского лагеря.', kk: 'Жауынгер лагері тағамы.', fr: 'Nutrition camp d\'entraînement. Protéines, glucides stratégiques.' },
