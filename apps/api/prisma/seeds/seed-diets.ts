...
const diets = [
    ...
    // 33) Autumn Harvest (AUTUMN_HARVEST)
    {
        slug: 'autumn-harvest',
        name: {
            en: 'Autumn Harvest', ru: 'Осенний урожай', kk: 'Күзгі егін', fr: 'Récolte d\' },
        description: {
    ...
    // 38) Sunday Brunch
    {
        ...
        description: {
            en: 'The art of leisurely Sunday brunch — late morning, good company, quality food, no rush.', ru: 'Искусство неспешного воскресного бранча — позднее утро, хорошая компания, качественная еда, без спешки.', kk: 'Баяу жексенбілік бранч өнері — кешкі таң, жақсы серіктестік, сапалы тағам, асықпау.', fr: 'L\' },
    ...
    // 41) French Girl Diet
    {
        ...
        description: {
            en: 'French approach to eating — quality portions, enjoyment, no strict restrictions, natural balance and pleasure.', ru: 'Французский подход к еде — качественные порции, удовольствие, без строгих запретов, естественный баланс и удовольствие.', kk: 'Тамаққа француз көзқарасы — сапалы порциялар, рахат, қатаң тыйымсыз, табиғи тепе-теңдік және рахат.', fr: 'Approche française : portions qualité, plaisir, pas d\' },
