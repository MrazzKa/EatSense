...
@Module({
  ...
  providers: [VisionService, PortionService, FoodLocalizationService, HiddenIngredientsService, FoodCompatibilityService, CarcinogenicRiskService, AnalyzeService],
