...
(function () {
  ...
  var translations = {
    en: {
      ...
      "pricing.free.name":"Free","pricing.free.desc":"Get started","pricing.free.period":"forever","pricing.free.f1":"1 scan per day","pricing.free.f2":"Basic nutrition data","pricing.free.f3":"7-day history","pricing.free.cta":"Get Started",
    ...
    de: {
      ...
      "pricing.free.name":"Kostenlos","pricing.free.desc":"Einstieg","pricing.free.period":"für immer","pricing.free.f1":"1 Scan pro Tag","pricing.free.f2":"Basis-Nährwertdaten","pricing.free.f3":"7-Tage-Verlauf","pricing.free.cta":"Loslegen",
    ...
    fr: {
      ...
      "pricing.free.name":"Gratuit","pricing.free.desc":"Commencer","pricing.free.period":"pour toujours","pricing.free.f1":"1 scan par jour","pricing.free.f2":"Données nutritionnelles de base","pricing.free.f3":"Historique de 7 jours","pricing.free.cta":"Commencer",
      ...
      "faq.tag":"FAQ","faq.title":"Vos questions, nos réponses","faq.q1":"EatSense est-il gratuit ?","faq.a1":"Oui. Vous pouvez scanner 1 repas par jour gratuitement, pour toujours. PRO débloque les scans illimités et les fonctions avancées.","faq.q2":"Quelle est la précision de l'analyse IA ?","faq.a2":"Notre IA estime calories et macros à partir d'une seule photo avec une grande précision, et vous pouvez toujours ajuster les portions.","faq.q3":"Quelles langues sont prises en charge ?","faq.a3":"EatSense est disponible en anglais, allemand, français, russe, kazakh et espagnol.","faq.q4":"Mes données sont-elles privées ?","faq.a4":"Absolument. Nous sommes suisses et conformes au RGPD. Vos données vous appartiennent — vous contrôlez ce que vous partagez.","faq.q5":"Puis-je travailler avec un vrai nutritionniste ?","faq.a5":"Oui. Le Marketplace d'Experts vous connecte à des professionnels certifiés qui peuvent voir les données que vous choisissez de partager.","faq.q6":"Est-ce disponible sur Android et iPhone ?","faq.a6":"EatSense est disponible sur l'App Store pour iPhone. Android arrive bientôt — inscrivez-vous à la liste d’attente pour une invitation anticipée.",
      "cta.title":"Mangez avec intention","cta.subtitle":"Téléchargez EatSense et transformez chaque repas en information.",
      "footer.tagline":"Nutrition IA, précision suisse. Comprenez ce que vous mangez.","footer.product":"Produit","footer.company":"Entreprise","footer.legal":"Mentions légales","footer.contact":"Contact","footer.privacy":"Politique de confidentialité","footer.terms":"Conditions d'utilisation","footer.support":"Support","footer.faq":"FAQ","footer.appstore":"App Store","footer.googleplay":"Google Play","footer.swiss":"Swiss Made","footer.gdpr":"Conforme RGPD","waitlist.tag":"Bientôt disponible","waitlist.title":"Android arrive bientôt","waitlist.subtitle":"Inscrivez-vous à la liste d’attente pour obtenir une invitation anticipée dès qu’EatSense arrive sur Google Play — places limitées.","waitlist.placeholder":"Votre e-mail","waitlist.cta":"Rejoindre la liste","waitlist.success":"Vous êtes sur la liste ! Nous vous contacterons.","waitlist.error":"Une erreur s’est produite. Veuillez réessayer.","waitlist.invalid":"Veuillez saisir une adresse e-mail valide."
    },
    ru: {
      ...
      "pricing.free.name":"Бесплатно","pricing.free.desc":"Начать","pricing.free.period":"навсегда","pricing.free.f1":"1 сканирование в день","pricing.free.f2":"Базовые данные о питании","pricing.free.f3":"История за 7 дней","pricing.free.cta":"Начать",
      ...
      "faq.tag":"ЧаВо","faq.title":"Отвечаем на вопросы","faq.q1":"EatSense бесплатный?","faq.a1":"Да. Вы можете сканировать 1 блюдо в день бесплатно, всегда. PRO открывает безлимит и расширенные функции.","faq.q2":"Насколько точен ИИ-анализ?","faq.a2":"Наш ИИ оценивает калории и макросы по одному фото с высокой точностью, а порции всегда можно подкорректировать.","faq.q3":"Какие языки поддерживаются?","faq.a3":"EatSense доступен на английском, немецком, французском, русском, казахском и испанском.","faq.q4":"Мои данные приватны?","faq.a4":"Абсолютно. Мы швейцарские и соответствуем GDPR. Ваши данные принадлежат вам — вы решаете, чем делиться.","faq.q5":"Могу ли я работать с настоящим нутрициологом?","faq.a5":"Да. Маркетплейс экспертов связывает вас с сертифицированными специалистами, которые видят данные, которыми вы решили поделиться.","faq.q6":"Доступно ли на Android и iPhone?","faq.a6":"EatSense доступен в App Store для iPhone. Android скоро — запишитесь в лист ожидания, чтобы получить ранний инвайт.",
      "cta.title":"Начните питаться осознанно","cta.subtitle":"Скачайте EatSense и превратите каждый приём пищи в инсайт.",
      "footer.tagline":"ИИ-питание, швейцарская точность. Понимайте, что вы едите.","footer.product":"Продукт","footer.company":"Компания","footer.legal":"Правовая информация","footer.contact":"Контакты","footer.privacy":"Политика конфиденциальности","footer.terms":"Условия использования","footer.support":"Поддержка","footer.faq":"ЧаВо","footer.appstore":"App Store","footer.googleplay":"Google Play","footer.swiss":"Сделано в Швейцарии","footer.gdpr":"Соответствие GDPR","waitlist.tag":"Скоро","waitlist.title":"Android уже в пути","waitlist.subtitle":"Запишитесь в лист ожидания, чтобы получить ранний инвайт, как только EatSense появится в Google Play — мест ограничено.","waitlist.placeholder":"Ваш e-mail","waitlist.cta":"В лист ожидания","waitlist.success":"Вы в списке! Мы свяжемся с вами.","waitlist.error":"Что-то пошло не так. Попробуйте ещё раз.","waitlist.invalid":"Введите корректный e-mail."
    },
    kk: {
      ...
      "pricing.free.name":"Тегін","pricing.free.desc":"Бастау","pricing.free.period":"әрдайым","pricing.free.f1":"Күніне 1 сканер","pricing.free.f2":"Негізгі тамақтану деректері","pricing.free.f3":"7-күндік тарих","pricing.free.cta":"Бастау",
    ...
    es: {
      ...
      "pricing.free.name":"Gratis","pricing.free.desc":"Empezar","pricing.free.period":"para siempre","pricing.free.f1":"1 escaneo al día","pricing.free.f2":"Datos básicos de nutrición","pricing.free.f3":"Historial de 7 días","pricing.free.cta":"Empezar",
      ...
      "faq.tag":"Preguntas frecuentes","faq.title":"Respondemos tus preguntas","faq.q1":"¿EatSense es gratis?","faq.a1":"Sí. Puedes escanear 1 comida al día gratis, para siempre. PRO desbloquea escaneos ilimitados y funciones avanzadas.","faq.q2":"¿Qué precisión tiene el análisis IA?","faq.a2":"Nuestra IA estima calorías y macros a partir de una sola foto con alta precisión, y siempre puedes ajustar las porciones.","faq.q3":"¿Qué idiomas son compatibles?","faq.a3":"EatSense está disponible en inglés, alemán, francés, ruso, kazajo y español.","faq.q4":"¿Mis datos son privados?","faq.a4":"Por supuesto. Somos suizos y cumplimos el RGPD. Tus datos son tuyos — tú controlas qué compartes.","faq.q5":"¿Puedo trabajar con un nutricionista real?","faq.a5":"Sí. El Marketplace de Expertos te conecta con profesionales certificados que pueden ver los datos que decidas compartir.","faq.q6":"¿Está disponible en Android y iPhone?","faq.a6":"EatSense está en la App Store para iPhone. Android llegará pronto — únete a la lista de espera para una invitación anticipada.",
      "cta.title":"Empieza a comer con intención","cta.subtitle":"Descarga EatSense y convierte cada comida en información.",
      "footer.tagline":"Nutrición IA, precisión suiza. Entiende lo que comes.","footer.product":"Producto","footer.company":"Empresa","footer.legal":"Legal","footer.contact":"Contacto","footer.privacy":"Política de privacidad","footer.terms":"Términos de servicio","footer.support":"Soporte","footer.faq":"Preguntas frecuentes","footer.appstore":"App Store","footer.googleplay":"Google Play","footer.swiss":"Hecho en Suiza","footer.gdpr":"Conforme al RGPD","waitlist.tag":"Próximamente","waitlist.title":"Android está en camino","waitlist.subtitle":"Únete a la lista de espera para recibir una invitación anticipada en cuanto EatSense llegue a Google Play — plazas limitadas.","waitlist.placeholder":"Tu correo","waitlist.cta":"Unirme a la lista","waitlist.success":"¡Estás en la lista! Te contactaremos.","waitlist.error":"Algo salió mal. Inténtalo de nuevo.","waitlist.invalid":"Introduce un correo válido."
    }
  };
  ...
  function initNav() {
    ...
    // expose so anchor-link handler can close the menu too
    window.__closeMenu = function () { setMenu(false); };
  ...
  /* ---------------- Waitlist (Android coming soon) ---------------- */
  function initWaitlist() {
    var form = $('#waitlistForm');
    if (!form) return;
    var input = $('#waitlistEmail'), btn = $('#waitlistBtn'), msg = $('#waitlistMsg');
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (!EMAIL_RE.test(email)) { msg.textContent = dict['waitlist.invalid']; msg.classList.add('err'); return; }
      btn.disabled = true;
      fetch(API + '/waitlist', {
        ...
        .then(function () { msg.textContent = dict['waitlist.success']; msg.classList.add('ok'); form.reset(); })
        .catch(function () { msg.textContent = dict['waitlist.error']; msg.classList.add('err'); })
