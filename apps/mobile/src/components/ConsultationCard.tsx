        ...
        >
            ...
            <View style={styles.avatarContainer}>
                {specialist?.avatarUrl ? (
                    ...
                    <View style={[styles.avatar, styles.avatarPlaceholder, { backgroundColor: colors.surfaceSecondary || colors.inputBackground || '#F3F4F6' }]}>
                        <Ionicons name="person" size={24} color={colors.textTertiary || '#9CA3AF'} />
                    </View>
                )}
                {unreadCount > 0 && (
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    <Text style={[styles.name, { color: colors.textPrimary || '#1F2937' }]} numberOfLines={1}>
                        {specialist?.displayName || 'Specialist'}
                    </Text>
                    <Text style={[styles.time, { color: colors.textTertiary || '#9CA3AF' }]}>
                ...
                <View style={styles.messageRow}>
                    <Text
                        style={[
                            ...
                            unreadCount > 0 && { color: colors.textPrimary || '#1F2937' },
                        ]}
                        numberOfLines={1}
                    >
